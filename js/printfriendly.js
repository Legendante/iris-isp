var PF_VERSION = "2016-08-15-132744429", pfMod = window.pfMod || function(e, t) {
  var i = e.document, n = i.location.protocol, o = {
    ...
    removeScripts: function() {
      for (var e = document.getElementsByTagName("script"), t = 0; t < e.length; t++) (a.onServer || "undefined" == typeof e[t].src || -1 === e[t].src.indexOf("printfriendly")) && e[t].parentNode && (e[t].parentNode.removeChild(e[t]), 
      t--);
    },
    processElements: function() {
      for (var t = "|link|style|iframe|noscript|object|embed|", i, n, o, r, s = document.body.getElementsByTagName("*"), a = 0; a < s.length; a++) try {
    ...
    processDocument: function() {
      this.removeScripts(), a.onServer || (this.processElements(), this.convertRelativetoAbsolute("a"), 
    ...
    start: function() {
      a.isRedirectNecessary() ? a.redirect() : a.supportedSiteType() && r.domReady(function() {
        try {
          a.startTime = new Date().getTime(), a.grabDataForAlgo(), r.processDocument(), a.detectPlatforms(), 
          a.cacheBodyHTML(), a.config.disableUI || a.createMask(), a.loadCore();
        } catch (e) {
          c.log(e);
        }
      });
    ...
    setVariables: function() {
      ...
      var r = t.config.hosts.cdn + t.config.filePath + t.version + "/main.css" + o;
    ...
    grabDataForAlgo: function() {
      a.metas = document.getElementsByTagName("meta");
    },
    detectAdBlock: function() {
      a.loadScript("https://cdnjs.cloudflare.com/ajax/libs/fuckadblock/3.2.1/fuckadblock.js", function() {
        function e(e) {
          var t = new XMLHttpRequest();
          t.open("POST", a.config.hosts.pf + "/stats", !0), t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), 
    ...
    cacheBodyHTML: function() {
      ...
      (a.browser.isIE || a.config.disableUI) && (document.body.innerHTML = "<p></p>");
    },
    refresh: function() {
