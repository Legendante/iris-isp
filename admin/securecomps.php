...
function openEditWindow(compid)
{
	...
	if(compid != 0)
	{
		...
		$.ajax({async: false, type: "POST", url: "ajaxGetSecurityCompany.php", dataType: "json",
			data: "dc=" + adate + "&cid=" + compid,
			success: function (feedback)
			{
				$('#compname').val(feedback.secname);
			},
...
<div class="panel panel-default">
	<div class="panel-heading"><h4>Security Companies
...
<div class='modal fade' id='company-modal' tabindex='-1' role='dialog' aria-hidden='true'>
	<form method='POST' action='saveSecureComp.php' id='secForm'>
	<input type='hidden' name='CompID' id='CompID' value='0'>
	<div class='modal-dialog modal-lg'>
		<div class='modal-content'>
			<div class='modal-header'><strong>Security Company<a href="#" class="close" data-dismiss="modal">&times;</a></strong></div>
